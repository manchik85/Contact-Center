!function (a) {
  ...
  function s(a, d, e, f, g, h) {
    ...
    if (f) for (v = 0, x = ib.length; x > v; v++) {
      var u = ib[v];
      if (u.el.id == d.id && u.anim == a) {
        u.percent != e ? (ib.splice(v, 1), k = 1) : j = u, d.attr(u.totalOrigin);
        break
      }
    } else f = +s;
    ...
    if (i) {
      if (j) j.initstatus = f, j.start = new Date - j.ms * f; else {
        ...
        if (n = i.start || a.start || +new Date, u = {
          ...
          "origin": d.attr(),
          "totalOrigin": g
        }, ib.push(u), f && !j && !k && (u.stop = !0, u.start = new Date - p * f, 1 == ib.length)) return kb();
  ...
  function t(a) {
    for (var b = 0; b < ib.length; b++) ib[b].el.paper == a && ib.splice(b--, 1)
  }
  ...
  var u, v, w = /[, ]+/, x = {"circle": 1, "rect": 1, "path": 1, "ellipse": 1, "text": 1, "image": 1}, y = /\{(\d+)\}/g,
    ...
    $ = N.round, _ = parseFloat, aa = parseInt, ba = I.prototype.toUpperCase, ca = c._availableAttrs = {
      "arrow-end": "none",
      "arrow-start": "none",
      "blur": 0,
    ...
    fa = {"hs": 1, "rg": 1}, ga = /,?([achlmqrstvxz]),?/gi,
  ...
  var ua = function (a) {
    if (c.vml) {
      ...
      i.title = "Rapha\xebl Colour Picker", i.style.display = "none", A.doc.body.appendChild(i), ua = f(function (a) {
    ...
    a *= 255, b *= 255, d *= 255;
    var f = {"r": a, "g": b, "b": d, "hex": c.rgb(a, b, d), "toString": xa};
    return c.is(e, "finite") && (f.opacity = e), f
  };
  c.color = function (a) {
    var b;
    return c.is(a, "object") && "h" in a && "s" in a && "b" in a ? (b = c.hsb2rgb(a), a.r = b.r, a.g = b.g, a.b = b.b, a.hex = b.hex) : c.is(a, "object") && "h" in a && "s" in a && "l" in a ? (b = c.hsl2rgb(a), a.r = b.r, a.g = b.g, a.b = b.b, a.hex = b.hex) : (c.is(a, "string") && (a = c.getRGB(a)), c.is(a, "object") && "r" in a && "g" in a && "b" in a ? (b = c.rgb2hsl(a), a.h = b.h, a.s = b.s, a.l = b.l, b = c.rgb2hsb(a), a.v = b.b) : (a = {"hex": "none"}, a.r = a.g = a.b = a.h = a.s = a.v = a.l = -1)), a.toString = xa, a
  ...
  c.getRGB = f(function (a) {
    ...
    return j ? (j[2] && (e = aa(j[2].substring(5), 16), d = aa(j[2].substring(3, 5), 16), b = aa(j[2].substring(1, 3), 16)), j[3] && (e = aa((h = j[3].charAt(3)) + h, 16), d = aa((h = j[3].charAt(2)) + h, 16), b = aa((h = j[3].charAt(1)) + h, 16)), j[4] && (i = j[4][J](ea), b = _(i[0]), "%" == i[0].slice(-1) && (b *= 2.55), d = _(i[1]), "%" == i[1].slice(-1) && (d *= 2.55), e = _(i[2]), "%" == i[2].slice(-1) && (e *= 2.55), "rgba" == j[1].toLowerCase().slice(0, 4) && (f = _(i[3])), i[3] && "%" == i[3].slice(-1) && (f /= 100)), j[5] ? (i = j[5][J](ea), b = _(i[0]), "%" == i[0].slice(-1) && (b *= 2.55), d = _(i[1]), "%" == i[1].slice(-1) && (d *= 2.55), e = _(i[2]), "%" == i[2].slice(-1) && (e *= 2.55), ("deg" == i[0].slice(-3) || "\xb0" == i[0].slice(-1)) && (b /= 360), "hsba" == j[1].toLowerCase().slice(0, 4) && (f = _(i[3])), i[3] && "%" == i[3].slice(-1) && (f /= 100), c.hsb2rgb(b, d, e, f)) : j[6] ? (i = j[6][J](ea), b = _(i[0]), "%" == i[0].slice(-1) && (b *= 2.55), d = _(i[1]), "%" == i[1].slice(-1) && (d *= 2.55), e = _(i[2]), "%" == i[2].slice(-1) && (e *= 2.55), ("deg" == i[0].slice(-3) || "\xb0" == i[0].slice(-1)) && (b /= 360), "hsla" == j[1].toLowerCase().slice(0, 4) && (f = _(i[3])), i[3] && "%" == i[3].slice(-1) && (f /= 100), c.hsl2rgb(b, d, e, f)) : (j = {
      "r": b,
      "g": d,
      "b": e,
      "toString": g
  ...
  }, null, Ca), La = (c._parseDots = f(function (a) {
  ...
  for (var Ra = function () {
    ...
    return A.doc.addEventListener ? function (a, b, c, d) {
      ...
      if (a.addEventListener(b, e, !1), F && L[b]) {
        var f = function (b) {
          for (var e = Va(b), f = b, g = 0, h = b.targetTouches && b.targetTouches.length; h > g; g++) if (b.targetTouches[g].target == a) {
            b = b.targetTouches[g], b.originalEvent = f, b.preventDefault = Sa, b.stopPropagation = Ua;
            break
          }
    ...
    Xa = []
  }, $a = c.el = {}, _a = K.length; _a--;) !function (a) {
    c[a] = $a[a] = function (b, d) {
      return c.is(b, "function") && (this.events = this.events || [], this.events.push({
        "name": a,
        "f": b,
        "unbind": Wa(this.shape || this.node || A.doc, a, b, d || this)
      })), this
    }, c["un" + a] = $a["un" + a] = function (b) {
  ...
  $a.drag = function (a, d, e, f, g, h) {
    function i(i) {
      ...
      this._drag.x = j + m, this._drag.y = k + l, !Xa.length && c.mousemove(Ya).mouseup(Za), Xa.push({
        "el": this,
        "move_scope": f,
        "start_scope": g,
        "end_scope": h
  ...
  }, $a.onDragOver = function (a) {
    a ? b.on("raphael.drag.over." + this.id, a) : b.unbind("raphael.drag.over." + this.id)
  }, $a.undrag = function () {
    for (var a = ab.length; a--;) ab[a].el == this && (this.unmousedown(ab[a].start), ab.splice(a, 1), b.unbind("raphael.drag.*." + this.id));
    !ab.length && c.unmousemove(Ya).unmouseup(Za), Xa = []
  ...
  v.getElementByPoint = function (a, b) {
  ...
  }, $a.isPointInside = function (a, b) {
    var d = this.realPath = qa[this.type](this);
    ...
    var b = {
      ...
      "offsety": a.offsety || 0,
      "color": a.color || "#000"
    }, c = b.width / 2, d = this.paper, e = d.set(), f = this.realPath || qa[this.type](this);
  ...
  var cb = function (a, b, d, e, f, g, h, i, l) {
      ...
      for (var g, h, i, j, k, l = "", m = {}, n = 0, o = 0, p = d.length; p > o; o++) {
        if (i = d[o], "M" == i[0]) g = +i[1], h = +i[2]; else {
          if (j = cb(g, h, i[1], i[2], i[3], i[4], i[5], i[6]), n + j > e) {
            ...
            if (!a && !b) return k = cb(g, h, i[1], i[2], i[3], i[4], i[5], i[6], e - n), {
              "x": k.x,
              "y": k.y,
              "alpha": k.alpha
            }
  ...
  }, eb = db(1), fb = db(), gb = db(0, 1);
  c.getTotalLength = eb, c.getPointAtLength = fb, c.getSubpath = function (a, b, c) {
    if (this.getTotalLength(a) - c < 1e-6) return gb(a, b).end;
    var d = gb(a, c, 1);
    return b ? gb(d, b).end : d
  }, $a.getTotalLength = function () {
    var a = this.getPath();
    if (a) return this.node.getTotalLength ? this.node.getTotalLength() : eb(a)
  }, $a.getPointAtLength = function (a) {
    var b = this.getPath();
    if (b) return fb(b, a)
  }, $a.getPath = function () {
    var a, b = c._getPath[this.type];
    if ("text" != this.type && "set" != this.type) return b && (a = b(this)), a
  }, $a.getSubpath = function (a, b) {
    var d = this.getPath();
  ...
  var ib = [],
    jb = a.requestAnimationFrame || a.webkitRequestAnimationFrame || a.mozRequestAnimationFrame || a.oRequestAnimationFrame || a.msRequestAnimationFrame || function (a) {
      setTimeout(a, 16)
    }, kb = function () {
      for (var a = +new Date, d = 0; d < ib.length; d++) {
        ...
        if (!e.el.removed && !e.paused) {
          var f, g, h = a - e.start, i = e.ms, j = e.easing, k = e.from, l = e.diff, m = e.to, n = (e.t, e.el), o = {},
            p = {};
          if (e.initstatus ? (h = (e.initstatus * e.anim.top - e.prev) / (e.percent - e.prev) * i, e.status = e.initstatus, delete e.initstatus, e.stop && ib.splice(d--, 1)) : e.status = (e.prev + (e.percent - e.prev) * (h / i)) / e.anim.top, !(0 > h)) if (i > h) {
            var q = j(h / i);
            ...
            }(e.callback, n, e.anim), n.attr(m), ib.splice(d--, 1), e.repeat > 1 && !e.next) {
  ...
  $a.animateWith = function (a, b, d, e, f, g) {
    ...
    for (var j = 0, k = ib.length; k > j; j++) if (ib[j].anim == b && ib[j].el == a) {
      ib[k - 1].start = ib[j].start;
      break
    }
    return h
  }, $a.onAnimation = function (a) {
    ...
    return new r(a, b)
  }, $a.animate = function (a, b, d, e) {
    var f = this;
    if (f.removed) return e && e.call(f), f;
    var g = a instanceof r ? a : c.animation(a, b, d, e);
    return s(g, f, g.percents[0], null, f.attr()), f
  }, $a.setTime = function (a, b) {
    return a && null != b && this.status(a, P(b, a.ms) / a.ms), this
  }, $a.status = function (a, b) {
    var c, d, e = [], f = 0;
    if (null != b) return s(a, this, -1, P(b, 1)), this;
    for (c = ib.length; c > f; f++) if (d = ib[f], d.el.id == this.id && (!a || d.anim == a)) {
      if (a) return d.status;
      e.push({"anim": d.anim, "status": d.status})
    }
    return a ? 0 : e
  }, $a.pause = function (a) {
    for (var c = 0; c < ib.length; c++) ib[c].el.id != this.id || a && ib[c].anim != a || b("raphael.anim.pause." + this.id, this, ib[c].anim) !== !1 && (ib[c].paused = !0);
    return this
  }, $a.resume = function (a) {
    for (var c = 0; c < ib.length; c++) if (ib[c].el.id == this.id && (!a || ib[c].anim == a)) {
      var d = ib[c];
    ...
    return this
  }, b.on("raphael.remove", t), b.on("raphael.clear", t), $a.toString = function () {
    return "Rapha\xebl\u2019s object"
  };
  var mb = function (a) {
    if (this.items = [], this.length = 0, this.type = "set", a) for (var b = 0, c = a.length; c > b; b++) !a[b] || a[b].constructor != $a.constructor && a[b].constructor != mb || (this[this.items.length] = this.items[this.items.length] = a[b], this.length++)
  }, nb = mb.prototype;
  nb.push = function () {
    for (var a, b, c = 0, d = arguments.length; d > c; c++) a = arguments[c], !a || a.constructor != $a.constructor && a.constructor != mb || (b = this.items.length, this[b] = this.items[b] = a, this.length++);
    return this
  }, nb.pop = function () {
  ...
  for (var ob in $a) $a[z](ob) && (nb[ob] = function (a) {
    return function () {
      var b = arguments;
  ...
  }, c.st = nb, b.on("raphael.DOMload", function () {
    u = !0
  }), function (a, b, d) {
    function e() {
