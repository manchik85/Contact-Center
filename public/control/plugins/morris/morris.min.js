...
(function () {
  ...
  b = window.Morris = {}, a = jQuery, b.EventEmitter = function () {
    ...
    return h(d, c), d.prototype.gridDefaults = {
      ...
      "events": [],
      "eventStrokeWidth": .1,
      "eventLineColors": ["#517fa4", "#9bce4a", "#29b6f6", "#a78de4", "#34d3eb", "#ee89c2", "#3b5998", "#517fa4", "#083E67", "#052C48"],
      "rangeSelect": null,
    ...
    return h(c, a), c.prototype.init = function () {
      ...
      "lineWidth": 2,
      "pointSize": 3,
      "lineColors": ["#7b62a4", "#7A92A3", "#4da74d", "#afd8f8", "#edc240", "#cb4b4b", "#9440ed"],
      "pointStrokeWidths": [1],
    ...
    return h(d, c), d.prototype.init = function () {
      ...
      "barGap": 1,
      "barColors":["#517fa4", "#9bce4a", "#29b6f6", "#a78de4", "#34d3eb", "#ee89c2", "#3b5998", "#517fa4", "#083E67", "#052C48"],
      "barOpacity": 1,
      "barRadius": [0, 0, 0, 0],
      "xLabelMargin": 10
    ...
    return h(d, c), d.prototype.defaults = {
      "colors": ["#a78de4", "#9bce4a", "#29b6f6", "#517fa4", "#34d3eb", "#ee89c2", "#3b5998", "#517fa4", "#083E67", "#052C48"],
