...
!function (a, b, c, d) {
  ...
  e.prototype = {
    "init": function () {
      ...
      var dataObj = {};
      dataObj.status = 'expand';
      dataObj.data_id = a.attr('data-id');
      dataObj.menu_id = a.attr('part-menu-id');

      $.ajax({
        type: 'POST',
        url: '/api/colapseMenuStatusItem',
        data: dataObj
      })
      ...
      if(b.hasClass('dd-collapsed')) {
        b.children('[data-action="collapse"]').hide();
      } else {
