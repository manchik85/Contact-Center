 ...
 * Generated for Laravel 5.8.35 on 2019-12-11 17:54:38.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Queue {
         ...
         *
         * @param int $id
         * @return \Barryvdh\Queue\DatabaseJob 
         * @static 
         */ 
        public static function getJobFromId($id)
        {
                        /** @var \Barryvdh\Queue\AsyncQueue $instance */
                        return $instance->getJobFromId($id);
        }
         ...
         * @static 
         */ 
        public static function startProcess($id)
        {
                        /** @var \Barryvdh\Queue\AsyncQueue $instance */
                        $instance->startProcess($id);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
                        \Barryvdh\Queue\AsyncQueue::createPayloadUsing($callback);
        }
